...
class MessageApiContractIntegrationTest {
    ...
    void shouldPersistFailedPublishAttemptWithFailureReason() throws Exception {
        ...
        net.jrodolfo.solace.broker.api.jpa.Message storedMessage = messageRepository.findAll().getFirst();
    ...
    void shouldReconcileStalePendingMessageAndPersistFailureReason() throws Exception {
        ...
        net.jrodolfo.solace.broker.api.jpa.Message pendingMessage = messageRepository.findAll().getFirst();
        ...
        net.jrodolfo.solace.broker.api.jpa.Message reconciledMessage = messageRepository.findById(pendingMessage.getId()).orElseThrow();
