...
class DirectPublisherServiceImplTest {
    ...
    void testSendMessageEmptyContent() {
        Exception exception = assertThrows(
                IllegalArgumentException.class,
                () -> directPublisherService.sendMessage(TestDestinations.SYSTEM_01, "", DeliveryMode.PERSISTENT, Optional.empty())
        );
    ...
    void testSendMessageMissingEnvironmentConfiguration() {
        ...
        BrokerConfigurationException exception = assertThrows(
                ...
                () -> service.sendMessage(TestDestinations.SYSTEM_01, "Message content", DeliveryMode.PERSISTENT, Optional.empty())
        );
