...
public class PagedMessagesResponseDTO {
    ...
    /**
     * Factory method to create a response from a page of JPA {@link net.jrodolfo.solace.broker.api.jpa.Message} entities.
     *
     * @param messagePage     The page of message entities.
     * @param lifecycleCounts Aggregate lifecycle statistics.
     * @return A new instance of {@link PagedMessagesResponseDTO}.
     */
    public static PagedMessagesResponseDTO fromMessages(Page<net.jrodolfo.solace.broker.api.jpa.Message> messagePage, LifecycleCountsDTO lifecycleCounts) {
