...
- The subscribed topic pattern is defined in [src/main/java/net/jrodolfo/solace/subscriber/Constants.java](src/main/java/net/jrodolfo/solace/subscriber/Constants.java).
